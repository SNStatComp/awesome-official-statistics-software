...
{{#items}}
- <img style="vertical-align:middle" src="badges/{{name}}/version.svg"></img>
<img style="vertical-align:middle" src="badges/{{name}}/latest.svg"></img>
<img style="vertical-align:middle" src="badges/{{name}}/license.svg"></img>\
